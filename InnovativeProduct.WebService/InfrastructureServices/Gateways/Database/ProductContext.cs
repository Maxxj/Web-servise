            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new
                {
                 ...
                 new
                 {
                     ...
                     Specifications = "Комплекс представляет собой автоматизированное рабочее место для межпредметных исследований по естественнонаучным дисциплинам. Комплекс включает более 155 наименований лабораторного оборудования,"+
                     " приборов, наборов, приспособлений, узлов и деталей, а также стеклянную, полимерную и керамическую посуду, инструменты и принадлежности, в том числе: ноутбук, комплект цифровых датчиков, цифровой микроскоп с"+
                     " набором микропрепаратов, электронные приборы (весы, термометр, дозиметр, мультиметр, ампервольтметр), источники электропитания 220/42В, 42/4.5В, аккумуляторный источник питания с зарядным устройством, калориметр,"+
                     " магнитная мешалка, набор по электрохимии, штативы с приспособлениями из нержавеющей стали и др. Состав: лабораторная посуда; штативы, наборы по механике; средства измерения; наборы по электродинамике, оптике и"+
                     " квантовым явлениям; источники питания, электрооборудование; микропрепараты, цифровая лаборатория."
                 }
            );
        }
    }
